...
const { getMyMegaMillionsPrize } = require('./megaMillions.js');
const { getMyDoublePlayPrize } = require('./doublePlay.js');
...
getMyPowerballPrize(myPowerballPlays);
getMyMegaMillionsPrize(myMegaMillionsPlay);
getMyDoublePlayPrize(myPowerballPlays);
